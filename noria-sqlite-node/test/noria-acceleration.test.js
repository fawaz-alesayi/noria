...
// ============================================================================
describe('View Synthesis', function () {
	beforeEach(function () {
...
// ============================================================================
describe('Cache Hits and Misses', function () {
	beforeEach(function () {
		this.db = new Database(util.next());
		this.db.exec('CREATE TABLE users (id INTEGER PRIMARY KEY, name TEXT, age INTEGER)');
	});
...
// ============================================================================
describe('CDC Propagation (The Real Test)', function () {
	beforeEach(function () {
		this.db = new Database(util.next());
		this.db.exec('CREATE TABLE users (id INTEGER PRIMARY KEY, name TEXT, age INTEGER)');
	});
...
// ============================================================================
describe('Correctness with Cache Verification', function () {
	beforeEach(function () {
		this.db = new Database(util.next());
		this.db.exec('CREATE TABLE users (id INTEGER PRIMARY KEY, name TEXT, age INTEGER)');
	});
